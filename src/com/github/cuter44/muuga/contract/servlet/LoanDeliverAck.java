 ...
 * <pre style="font-size:12px">
   ...
   <strong>请求</strong>
   POST /contract/loan/deliver-ack.api
 ...
 *
 */
@WebServlet("/contract/loan/deliver-ack.api")
public class LoanDeliverAck extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            LoanContract loan = this.loanCtl.deliverAck(id, uid);
