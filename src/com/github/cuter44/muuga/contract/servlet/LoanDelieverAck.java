 ...
 * <pre style="font-size:12px">
   ...
   <strong>请求</strong>
   POST /contract/loan/deliever-ack.api
 ...
 *
 */
@WebServlet("/contract/loan/deliever-ack.api")
public class LoanDelieverAck extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            LoanContract loan = this.loanCtl.delieverAck(id, uid);
